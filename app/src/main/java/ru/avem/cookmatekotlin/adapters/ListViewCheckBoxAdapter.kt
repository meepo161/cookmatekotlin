package ru.avem.cookmatekotlin.adapters
...
class ListViewCheckBoxAdapter(private val dataSet: ArrayList<*>, mContext: Context) :
    ...
    override fun getItem(position: Int): CheckModel {
        return dataSet[position] as CheckModel
    }
    ...
    override fun getView(
        ...
        val item: CheckModel = getItem(position)
